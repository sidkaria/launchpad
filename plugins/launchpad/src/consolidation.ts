...
import type { DetectedPipeline } from './types.js';
 ...
 */
export function isLaunchpadWorkflow(path: string): boolean {
 ...
 */
export function nonLaunchpadWorkflows(pipelines: DetectedPipeline[]): string[] {
  return pipelines
